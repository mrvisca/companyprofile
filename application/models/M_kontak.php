...
class M_kontak extends CI_Model{
	...
	function kirim_pesan($nama,$email,$inbox_subyek,$pesan){
		$hsl=$this->db->query("INSERT INTO tbl_inbox(inbox_nama,inbox_email,inbox_subyek,inbox_pesan) VALUES ('$nama','$email','$inbox_subyek','$pesan')");
		return $hsl;
	}
