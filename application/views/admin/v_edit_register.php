...
<head>
  ...
  <title>Firna.co.id | Tambah Register</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Register</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Form Edit Register</h3>
        </div>
	      <form action="<?php echo base_url().'admin/register/update_register'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              ...
              <input type="text" name="nama" class="form-control" value="<?php echo $b['nama'];?>" placeholder="Nama Lengkap" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>No.Telepon</label>
              <input type="text" name="telepon" class="form-control" value="<?php echo $b['telepon'];?>" placeholder="Nomer Telepon Aktif" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Kode Refferal</label>
              <input type="text" name="refferal" class="form-control" value="<?php echo $b['refferal'];?>" placeholder="Kode Refferal Member" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Paket</label>
              <input type="text" name="paket" class="form-control" value="<?php echo $b['paket'];?>" placeholder="Paket yang akan dipilih" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Pesan</label>
              <input type="text" name="pesan" class="form-control" value="<?php echo $b['pesan'];?>" placeholder="Pesan" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Pesan</label>
              <input type="text" name="tanggal" class="form-control" value="<?php echo $b['tanggal'];?>" placeholder="Tanggal Input Pesan" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-10">
