...
<head>
  ...
  <title>Firna.co.id | Tambah Visi Misi</title>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Judul</h3>
		    ...
		    <form action="<?php echo base_url().'admin/visi/update_visi'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              ...
              <label>Judul</label>
              <input type="text" name="judul" class="form-control" value="<?php echo $b['judul'];?>" placeholder="Judul"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Visi</label>
              <textarea id="ckeditor" name="visi"><?php echo $b['visi'];?></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Misi</label>
              <textarea class="ckeditor" id="ckeditor" name="misi"><?php echo $b['misi'];?></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Profil</label>
              <textarea class="ckeditor" id="ckeditor" name="profil"><?php echo $b['profil'];?></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Fitur</label>
              <input type="text" name="fitur" class="form-control" value="<?php echo $b['fitur'];?>" placeholder="Fitur Konten"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Presentase</label>
              <input type="text" name="presentase" class="form-control" value="<?php echo $b['presentase'];?>" placeholder="Presentase Konten"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Fitur 2</label>
              <input type="text" name="fitur2" class="form-control" value="<?php echo $b['fitur2'];?>" placeholder="Fitur Konten 2"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Presentase 2</label>
              <input type="text" name="presentase2" class="form-control" value="<?php echo $b['presentase2'];?>" placeholder="Presentase Konten 2"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Fitur 3</label>
              <input type="text" name="fitur3" class="form-control" value="<?php echo $b['fitur3'];?>" placeholder="Fitur Konten 3"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Presentase 3</label>
              <input type="text" name="presentase3" class="form-control" value="<?php echo $b['presentase3'];?>" placeholder="Presentase Konten 3"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Fitur 4</label>
              <input type="text" name="fitur4" class="form-control" value="<?php echo $b['fitur4'];?>" placeholder="Fitur Konten 4"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Presentase 5</label>
              <input type="text" name="presentase4" class="form-control" value="<?php echo $b['presentase4'];?>" placeholder="Presentase Konten 4"/>
            </div>
            <!-- /.col -->
            <div class="col-md-10">
