...
<head>
  ...
  <title>Firna.co.id | Tambah Testimoni</title>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Form Edit Testimoni</h3>
        </div>
		    <form action="<?php echo base_url().'admin/testimoni/update_testimoni'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
            ...
            <div class="col-md-10">
              ...
              <textarea id="ckeditor" name="pendapat"><?php echo $b['pendapat'];?></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Status Member</label>
              <input type="text" name="status_member" class="form-control" value="<?php echo $b['status_member'];?>" placeholder="Status Member"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Photo</label>
