...
<head>
  ...
  <title>Firna.co.id | Tambah Banner</title>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Judul</h3>
		    ...
		    <form action="<?php echo base_url().'admin/banner/simpan_banner'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-5">
            ...
            <div class="col-md-5">
              <input type="text" name="subjudul" class="form-control" placeholder="Sub Judul" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Nama Tombol</h3>
            </div>
            <div class="box-body">
			        <div class="form-group">
                <label>Gambar</label>
                <input type="text" name="button_name" style="width: 100%;" required>
              </div>
              <!-- /.form group -->
            </div>
            <!-- /.box-body -->
