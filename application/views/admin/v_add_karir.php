...
<head>
  ...
  <title>Firna.co.id | Tambah Karir</title>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Form Tambah Karir</h3>
        </div>
		
		<form action="<?php echo base_url().'admin/karir/simpan_karir'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-10">
              ...
              <textarea id="ckeditor" name="alamat" required></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Telepon</label>
              <input type="text" name="telepon" class="form-control" placeholder="No Telepon Aktif" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Email</label>
            ...
            <div class="col-md-10">
              <br />
              <label>Foto</label>
              <input type="file" name="filefoto" style="width: 100%;" required/><p>Masukan Foto Formal Terbaikmu</p>
            </div>
            <div class="col-md-10">
              <br />
              <label>Dokumen</label>
              <input type="file" name="filedokumen" style="width: 100%;" required/><p>Masukan File Dokumen Lamaran/Surat Magang</p>
            </div>
            <!-- /.col -->
            <div class="col-md-10">
