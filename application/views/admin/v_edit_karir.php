...
<head>
  ...
  <title>Firna.co.id | Edit Karir</title>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
	      ...
	      <form action="<?php echo base_url().'admin/karir/update_Karir'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              ...
              <input type="text" name="nama" class="form-control" value="<?php echo $b['nama'];?>" placeholder="Nama Lengkap"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Alamat Domisili</label>
              <textarea id="ckeditor" name="alamat" required><?php echo $b['alamat'];?></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>No.Telepon</label>
              <input type="text" name="telepon" class="form-control" value="<?php echo $b['telepon'];?>" placeholder="Masukan No.Telepon Aktif kamu"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Email</label>
              <input type="text" name="email" class="form-control" value="<?php echo $b['email'];?>" placeholder="Masukan Alamat Email Kamu"/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Foto</label>
              <input type="file" name="filefoto" style="width: 100%;" /><p>Masukan Foto Formal Terbaikmu</p>
            </div>
            <div class="col-md-10">
              <br />
              <label>Email</label>
              <input type="file" name="filedokumen" style="width: 100%;" /><p>Masukan File Dokumen Lamaran/Surat Magang</p>
            </div>
            <!-- /.col -->
            <div class="col-md-10">
