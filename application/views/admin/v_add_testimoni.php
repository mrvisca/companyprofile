      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Form Tambah Testimoni</h3>
		    ...
		    <form action="<?php echo base_url().'admin/testimoni/simpan_testimoni'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
            ...
            <div class="col-md-10">
              ...
              <textarea id="ckeditor" name="pendapat" required></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Status Member</label>
              <input type="text" name="status_member" class="form-control" placeholder="Status Member" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Photo</label>
