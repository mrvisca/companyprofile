...
<head>
  ...
  <title>Firna.co.id | Layanan</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <!--<a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/layanan/add_layanan'?>"><span class="fa fa-plus"></span> Tambah Layanan</a>-->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
          				<?php
          					$no=0;
          					foreach ($data->result_array() as $l) :
                      $no++;
                      $id=$l['id'];
                      $judul=$l['judul'];
                ...
                <tr>
                  <td><?php echo $judul;?></td>
        				  ...
        				  <td><img src="<?php echo base_url().'assets/upload/gambar/'.$gambar;?>" style="width:90px;"></td>
                  <td style="text-align:right;">
                    <a class="btn" href="<?php echo base_url().'admin/layanan/get_edit/'.$id;?>"><span class="fa fa-pencil"></span></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">       
              ...
              <p>Apakah Anda yakin mau menghapus Layanan <b><?php echo $judul;?></b> ?</p>
