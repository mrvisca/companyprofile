...
<head>
  ...
  <title>Firna.co.id | Edit Banner</title>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Judul</h3>
		    ...
		    <form action="<?php echo base_url().'admin/banner/update_banner'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-5">
            ...
            <div class="col-md-5">
              <input type="text" name="subjudul" class="form-control" value="<?php echo $b['subjudul'];?>" placeholder="Sub Judul"/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <input type="text" name="button_name" style="width: 100%;" value="<?php echo $b['button_name'];?>">
              </div>
              <!-- /.form group -->
            </div>
            <!-- /.box-body -->
