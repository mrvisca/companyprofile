...
<head>
  ...
  <title>Firna.co.id | Gallery</title>
          ...
          <div class="box">
            <div class="box">
              <div class="box-header">
                <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/gallery/add_gallery'?>"><span class="fa fa-plus"></span> Tambah Foto</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'admin/gallery/get_edit/'.$id;?>"><span class="fa fa-pencil"></span></a>
...
<?php foreach ($data->result_array() as $g) :
  $id=$g['id'];
  $foto=$g['foto'];
  $alt=$g['alt'];
  $kategori=$g['kategori'];
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">       
              ...
              <p>Apakah Anda yakin mau menghapus Gambar <b><?php echo $alt;?></b> ?</p>     
            </div>
  ...
  $(function () {
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Gallery Berhasil disimpan ke database.",
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Gallery berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
