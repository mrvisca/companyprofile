    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Form Tambah Visi Misi</h3>
        </div>
		    <form action="<?php echo base_url().'admin/visi/simpan_visi'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
            ...
            <div class="col-md-10">
              <br />
              <label>Visi</label>
              <textarea id="ckeditor" name="visi" required></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Misi</label>
            ...
            <div class="col-md-10">
              <br />
              <label>Profil</label>
              <textarea class="ckeditor" id="ckeditor" name="profil" required></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Fitur</label>
              <input type="text" name="fitur" class="form-control" placeholder="Fitur Konten" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Presentase</label>
              <input type="text" name="presentase" class="form-control" placeholder="Presentase Konten" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Fitur 2</label>
              <input type="text" name="fitur2" class="form-control" placeholder="Fitur Konten 2" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Presentase 2</label>
              <input type="text" name="presentase2" class="form-control" placeholder="Presentase Konten 2" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Fitur 3</label>
              <input type="text" name="fitur3" class="form-control" placeholder="Fitur Konten 3" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Presentase 3</label>
              <input type="text" name="presentase3" class="form-control" placeholder="Presentase Konten 3" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Fitur 4</label>
              <input type="text" name="fitur4" class="form-control" placeholder="Fitur Konten 4" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Presentase 4</label>
              <input type="text" name="presentase4" class="form-control" placeholder="Presentase Konten 4" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-10">
