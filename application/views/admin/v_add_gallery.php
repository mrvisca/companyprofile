...
<head>
  ...
  <title>Firna.co.id | Tambah Gallery</title>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Form Tambah Foto</h3>
        </div>
	      <form action="<?php echo base_url().'admin/gallery/simpan_gallery'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
            ...
            <div class="col-md-10">
              <br/>
              <label>Alt</label>
              <input type="text" name="alt" class="form-control" placeholder="Nama Alternatif Gambar" required/>
            </div>
            <div class="col-md-10">
              <br/>
              ...
              <select name="kategori" class="form-control select2" required>
                ...
                <?php
                  $no=0;
                  foreach ($usaha->result_array() as $u) :
                    $no++;
                    $id=$u['id'];
                    $nama=$u['nama'];    
                ?>
