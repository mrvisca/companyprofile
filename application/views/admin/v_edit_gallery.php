...
<head>
  ...
  <title>Firna.co.id | Edit Gallery</title>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Judul</h3>
		    ...
		    <form action="<?php echo base_url().'admin/gallery/update_gallery'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
            ...
            <div class="col-md-10">
              <br/>
              <label>Alt</label>
              <input type="text" name="alt" class="form-control" value="<?php echo $b['alt'];?>" placeholder="Alternatif Foto" required/>
            </div>
            <div class="col-md-10">
              <br/>
              <label>Kategori</label>
              <select nama="kategori" class="form-control" required>
                <option disabled> --- Pilih Kategori --- </option>
                <?php
                  foreach ($usaha->result_array() as $i) {
                    $id=$i['id'];
                    $nama=$i['nama'];
                    if($b['kategori']==$nama)
