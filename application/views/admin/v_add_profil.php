...
<head>
  ...
  <title>Firna.co.id | Tambah Profil</title>
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-10">
              <br />
              <label>Deksirpsi Profil</label>
              <textarea id="ckeditor" name="deskripsi" required></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Judul Konten</label>
              <input type="text" name="judulkonten" class="form-control" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Deksirpsi Konten</label>
              <textarea class="ckeditor" id="ckeditor" name="deskripsikonten" required></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Ikon Konten</label>
              <input type="text" name="ikon" class="form-control" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Judul Konten 2</label>
              <input type="text" name="judulkonten2" class="form-control" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Deksirpsi Konten 2</label>
              <textarea class="ckeditor" id="ckeditor" name="deskripsikonten2" required></textarea>
            </div>
            <div class="col-md-10">
              <br />
              <label>Ikon Konten 2</label>
              <input type="text" name="ikon2" class="form-control" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-10">
