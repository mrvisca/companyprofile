...
<head>
  ...
  <title>Firna.co.id | Register</title>
          ...
          <div class="box">
            <div class="box">
              <div class="box-header">
                <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/register/add_register'?>"><span class="fa fa-plus"></span> Tambah Register</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                  ...
                  <tbody>
                    <?php
                      ...
                      foreach ($data->result_array() as $r) :
                        ...
                        $paket=$r['paket'];
                        $pesan=$r['pesan'];
                        $tanggal=date('d-m-Y H:i:s',  $r['tanggal']);
                      ?>
                  <tr>
                    <td><?php echo $nama;?></td>
                    <td><?php echo $telepon;?></td>
                    <td><?php echo $refferal;?></td>
                    <td><?php echo $paket;?></td>
                    <td><?php echo $pesan;?></td>
                    <td><?php echo $tanggal;?></td>
                    <td style="text-align:right;">
                          <a class="btn" href="<?php echo base_url().'admin/register/get_edit/'.$id;?>"><span class="fa fa-pencil"></span></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Hapus Register</h4>
            </div>
            <form class="form-horizontal" action="<?php echo base_url().'admin/register/hapus_register'?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">       
              <input type="hidden" name="id" value="<?php echo $id;?>"/>
              <input type="hidden" name="nama" value="<?php echo $nama;?>"/>
              <input type="hidden" name="telepon" value="<?php echo $telepon;?>"/>
              <input type="hidden" name="refferal" value="<?php echo $refferal;?>"/>
              <input type="hidden" name="paket" value="<?php echo $paket;?>"/>
              <input type="hidden" name="pesan" value="<?php echo $pesan;?>"/>
              <input type="hidden" name="tanggal" value="<?php echo $tanggal;?>"/>
              <p>Apakah Anda yakin mau menghapus Register <b><?php echo $nama;?></b> ?</p>       
            </div>
  ...
  $(function () {
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Register Berhasil disimpan ke database.",
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Register berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Register Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
