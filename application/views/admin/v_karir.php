          ...
          <div class="box">
            <div class="box">
              <div class="box-header">
                <!--<a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/karir/add_karir'?>"><span class="fa fa-plus"></span> Tambah Karir</a>-->
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <table id="example1" class="table table-striped" style="font-size:13px;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="<?php echo base_url().'assets/upload/gambar/'.$foto;?>" style="width:90px;"></td>
                      <td><a href="<?php echo base_url().'assets/upload/dokumen/'.$dokumen;?>"><?php echo $dokumen;?></a></td>
                      <td style="text-align:right;">
                        <!--<a class="btn" href="<?php echo base_url().'admin/karir/get_edit/'.$id;?>"><span class="fa fa-pencil"></span></a>-->
...
<?php foreach ($data->result_array() as $k) :
  $id=$k['id'];
  $nama=$k['nama'];
  $alamat=$k['alamat'];
  $telepon=$k['telepon'];
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Hapus Karir</h4>
            </div>
            <form class="form-horizontal" action="<?php echo base_url().'admin/karir/hapus_karir'?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">       
              ...
              <input type="hidden" name="dokumen" value="<?php echo $dokumen;?>"/>
                    <p>Apakah Anda yakin mau menghapus karir <b><?php echo $nama;?></b> ?</p>
  ...
  $(function () {
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Karir Berhasil disimpan ke database.",
