...
<head>
  ...
  <title>Firna.co.id | Tentang Kami</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <!--<a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/profil/add_profil'?>"><span class="fa fa-plus"></span> Tambah Profil</a>-->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  <td><?php echo $judul;?></td>
        				  ...
        				  <td><?php echo $judulkonten;?></td>
                  <td><?php echo $judulkonten2;?></td>
                  <td style="text-align:right;">
                    <a class="btn" href="<?php echo base_url().'admin/profil/get_edit/'.$id;?>"><span class="fa fa-pencil"></span></a>
...
<!-- ./wrapper -->
	<?php foreach ($data->result_array() as $p) :
    $id=$p['id'];
    $judul=$p['judul'];
    $deskripsi=$p['deskripsi'];
    $judulkonten=$p['judulkonten'];
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/profil/hapus_profil'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                     <input type="hidden" name="judul" value="<?php echo $judul;?>"/>
                     <input type="hidden" name="deskripsi" value="<?php echo $deskripsi;?>"/>
                     <input type="hidden" name="judulkonten" value="<?php echo $judulkonten;?>"/>
                     <input type="hidden" name="judulkonten2" value="<?php echo $judulkonten2;?>"/>
                            <p>Apakah Anda yakin mau menghapus Profil <b><?php echo $judul;?></b> ?</p>
