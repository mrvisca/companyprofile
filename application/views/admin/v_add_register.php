  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Register</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Form Tambah Register</h3>
        </div>
		    <form action="<?php echo base_url().'admin/register/simpan_register'?>" method="post" enctype="multipart/form-data">
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
            ...
            <div class="col-md-10">
              ...
              <input type="text" name="telepon" class="form-control" placeholder="Nomer Telepon Aktif" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Kode Refferal</label>
              <input type="text" name="refferal" class="form-control" placeholder="Kode Refferal Member" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Paket</label>
              <input type="text" name="paket" class="form-control" placeholder="Paket yang akan dipilih" required/>
            </div>
            <div class="col-md-10">
              <br />
              <label>Pesan</label>
            ...
            <div class="col-md-10">
              <br />
              <label>Tanggal</label>
              <input type="text" name="tanggal" class="form-control" placeholder="Tanggal Input Pesan" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-10">
